  ...
  ngOnInit(): void {
    {
      ...
      this.datosPersona.getPersona().subscribe((data) => {
        if(data){
          swal("Bienvenido a mi portfolio","Soy Desarrollador Full-Stack Jr, Tester Manual Tr y estudiante avanzado de la carrera Tecnicatura Universitaria en Programación en la UTN de Mar del Plata.","");
